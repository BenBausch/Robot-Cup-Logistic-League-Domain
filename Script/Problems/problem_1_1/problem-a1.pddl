...
(:init
   ...
   (= (path-length rs0_in cs1_in) 27)
   (= (path-length rs0_in cs1_out) 26)
   (= (path-length rs0_out cs1_in) 28)
   (= (path-length rs0_out cs1_out) 27)
   ...
   (= (path-length cs1_in rs0_in) 27)
   (= (path-length cs1_in rs0_out) 28)
   (= (path-length cs1_out rs0_in) 26)
   (= (path-length cs1_out rs0_out) 27)
