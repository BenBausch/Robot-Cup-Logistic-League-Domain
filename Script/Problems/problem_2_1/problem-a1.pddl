...
(:init
   ...
   (= (path-length bs0_in rs0_out) 6)
   (= (path-length bs0_out rs0_in) 4)
   (= (path-length bs0_out rs0_out) 5)
   (= (path-length bs0_in rs1_in) 22)
   (= (path-length bs0_in rs1_out) 23)
   (= (path-length bs0_out rs1_in) 21)
   ...
   (= (path-length rs0_in bs0_out) 4)
   (= (path-length rs0_out bs0_in) 6)
   ...
   (= (path-length rs1_in bs0_out) 21)
   (= (path-length rs1_out bs0_in) 23)
   ...
   (= (path-length rs1_in ds0_in) 4)
   (= (path-length rs1_out ds0_in) 5)
   ...
   (= (path-length cs0_out cs1_in) 13)
   (= (path-length cs0_out cs1_out) 13)
   (= (path-length cs0_in ds0_in) 19)
   (= (path-length cs0_out ds0_in) 18)
   ...
   (= (path-length ds0_in rs1_in) 4)
   (= (path-length ds0_in rs1_out) 5)
   (= (path-length ds0_in cs0_in) 19)
   (= (path-length ds0_in cs0_out) 18)
