...
(:init
   ...
   (material-required gray_ring_p2 two)
   (material-required black_ring_p2 one)
   ...
   (material-required gray_cap_p2 two)
   ...
   (= (path-length start bs0_in) 27)
   (= (path-length bs0_in start) 27)
   (= (path-length start bs0_out) 26)
   (= (path-length bs0_out start) 26)
   (= (path-length start rs0_in) 19)
   (= (path-length rs0_in start) 19)
   (= (path-length start rs0_out) 18)
   (= (path-length rs0_out start) 18)
   (= (path-length start rs1_in) 37)
   (= (path-length rs1_in start) 37)
   (= (path-length start rs1_out) 37)
   (= (path-length rs1_out start) 37)
   ...
   (= (path-length start cs1_out) 19)
   (= (path-length cs1_out start) 19)
   (= (path-length start ds0_in) 10)
   (= (path-length ds0_in start) 10)
   ...
   (= (path-length bs0_in rs1_in) 24)
   (= (path-length bs0_in rs1_out) 26)
   (= (path-length bs0_out rs1_in) 24)
   (= (path-length bs0_out rs1_out) 24)
   (= (path-length bs0_in cs0_in) 15)
   (= (path-length bs0_in cs0_out) 17)
   (= (path-length bs0_out cs0_in) 14)
   (= (path-length bs0_out cs0_out) 15)
   (= (path-length bs0_in cs1_in) 9)
   (= (path-length bs0_in cs1_out) 11)
   (= (path-length bs0_out cs1_in) 8)
   (= (path-length bs0_out cs1_out) 9)
   (= (path-length bs0_in ds0_in) 20)
   (= (path-length bs0_out ds0_in) 19)
   ...
   (= (path-length rs0_in rs1_in) 21)
   (= (path-length rs0_in rs1_out) 21)
   (= (path-length rs0_out rs1_in) 20)
   (= (path-length rs0_out rs1_out) 21)
   (= (path-length rs0_in cs0_in) 6)
   (= (path-length rs0_in cs0_out) 8)
   (= (path-length rs0_out cs0_in) 6)
   (= (path-length rs0_out cs0_out) 6)
   (= (path-length rs0_in cs1_in) 3)
   (= (path-length rs0_in cs1_out) 1)
   (= (path-length rs0_out cs1_in) 4)
   (= (path-length rs0_out cs1_out) 3)
   (= (path-length rs0_in ds0_in) 10)
   (= (path-length rs0_out ds0_in) 10)
   (= (path-length rs1_in bs0_in) 24)
   (= (path-length rs1_in bs0_out) 24)
   (= (path-length rs1_out bs0_in) 26)
   (= (path-length rs1_out bs0_out) 24)
   (= (path-length rs1_in rs0_in) 21)
   (= (path-length rs1_in rs0_out) 20)
   (= (path-length rs1_out rs0_in) 21)
   (= (path-length rs1_out rs0_out) 21)
   ...
   (= (path-length rs1_out cs0_in) 16)
   (= (path-length rs1_out cs0_out) 15)
   (= (path-length rs1_in cs1_in) 22)
   (= (path-length rs1_in cs1_out) 22)
   (= (path-length rs1_out cs1_in) 23)
   (= (path-length rs1_out cs1_out) 22)
   (= (path-length rs1_in ds0_in) 27)
   (= (path-length rs1_out ds0_in) 27)
   (= (path-length cs0_in bs0_in) 15)
   (= (path-length cs0_in bs0_out) 14)
   (= (path-length cs0_out bs0_in) 17)
   (= (path-length cs0_out bs0_out) 15)
   (= (path-length cs0_in rs0_in) 6)
   (= (path-length cs0_in rs0_out) 6)
   (= (path-length cs0_out rs0_in) 8)
   (= (path-length cs0_out rs0_out) 6)
   (= (path-length cs0_in rs1_in) 15)
   (= (path-length cs0_in rs1_out) 16)
   ...
   (= (path-length cs0_in cs1_in) 9)
   (= (path-length cs0_in cs1_out) 7)
   (= (path-length cs0_out cs1_in) 10)
   (= (path-length cs0_out cs1_out) 9)
   (= (path-length cs0_in ds0_in) 12)
   (= (path-length cs0_out ds0_in) 12)
   (= (path-length cs1_in bs0_in) 9)
   (= (path-length cs1_in bs0_out) 8)
   (= (path-length cs1_out bs0_in) 11)
   (= (path-length cs1_out bs0_out) 9)
   (= (path-length cs1_in rs0_in) 3)
   (= (path-length cs1_in rs0_out) 4)
   (= (path-length cs1_out rs0_in) 1)
   (= (path-length cs1_out rs0_out) 3)
   (= (path-length cs1_in rs1_in) 22)
   (= (path-length cs1_in rs1_out) 23)
   (= (path-length cs1_out rs1_in) 22)
   (= (path-length cs1_out rs1_out) 22)
   (= (path-length cs1_in cs0_in) 9)
   (= (path-length cs1_in cs0_out) 10)
   (= (path-length cs1_out cs0_in) 7)
   (= (path-length cs1_out cs0_out) 9)
   (= (path-length cs1_in cs1_in) 0)
   (= (path-length cs1_in cs1_out) 2)
   (= (path-length cs1_out cs1_in) 2)
   (= (path-length cs1_out cs1_out) 0)
   (= (path-length cs1_in ds0_in) 12)
   (= (path-length cs1_out ds0_in) 11)
   (= (path-length ds0_in bs0_in) 20)
   (= (path-length ds0_in bs0_out) 19)
   (= (path-length ds0_in rs0_in) 10)
   (= (path-length ds0_in rs0_out) 10)
   (= (path-length ds0_in rs1_in) 27)
   (= (path-length ds0_in rs1_out) 27)
   (= (path-length ds0_in cs0_in) 12)
   (= (path-length ds0_in cs0_out) 12)
   (= (path-length ds0_in cs1_in) 12)
