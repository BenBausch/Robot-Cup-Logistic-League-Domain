...
(:init
   ...
   (material-required red_ring_p2 one)
   ...
   (= (path-length start bs0_in) 34)
   (= (path-length bs0_in start) 34)
   (= (path-length start bs0_out) 34)
   (= (path-length bs0_out start) 34)
   (= (path-length start rs0_in) 32)
   (= (path-length rs0_in start) 32)
   (= (path-length start rs0_out) 32)
   (= (path-length rs0_out start) 32)
   (= (path-length start rs1_in) 18)
   (= (path-length rs1_in start) 18)
   (= (path-length start rs1_out) 18)
   (= (path-length rs1_out start) 18)
   (= (path-length start cs0_in) 7)
   (= (path-length cs0_in start) 7)
   (= (path-length start cs0_out) 7)
   (= (path-length cs0_out start) 7)
   (= (path-length start cs1_in) 21)
   (= (path-length cs1_in start) 21)
   (= (path-length start cs1_out) 21)
   (= (path-length cs1_out start) 21)
   (= (path-length start ds0_in) 4)
   (= (path-length ds0_in start) 4)
   ...
   (= (path-length bs0_in cs1_out) 17)
   (= (path-length bs0_out cs1_in) 19)
   (= (path-length bs0_out cs1_out) 18)
   (= (path-length bs0_in ds0_in) 30)
   (= (path-length bs0_out ds0_in) 30)
   ...
   (= (path-length rs0_in ds0_in) 29)
   (= (path-length rs0_out ds0_in) 28)
   ...
   (= (path-length rs1_in cs1_in) 4)
   (= (path-length rs1_in cs1_out) 5)
   (= (path-length rs1_out cs1_in) 4)
   (= (path-length rs1_out cs1_out) 4)
   ...
   (= (path-length cs1_in rs1_in) 4)
   (= (path-length cs1_in rs1_out) 4)
   (= (path-length cs1_out rs1_in) 5)
   (= (path-length cs1_out rs1_out) 4)
   ...
   (= (path-length ds0_in bs0_in) 30)
   (= (path-length ds0_in bs0_out) 30)
   (= (path-length ds0_in rs0_in) 29)
   (= (path-length ds0_in rs0_out) 28)
