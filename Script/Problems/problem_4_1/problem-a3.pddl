...
(:init
   ...
   (= (path-length start bs0_out) 30)
   (= (path-length bs0_out start) 30)
   ...
   (= (path-length start cs0_in) 35)
   (= (path-length cs0_in start) 35)
   (= (path-length start cs0_out) 35)
   (= (path-length cs0_out start) 35)
   ...
   (= (path-length ds0_in rs1_out) 22)
   (= (path-length ds0_in cs0_in) 15)
   (= (path-length ds0_in cs0_out) 15)
