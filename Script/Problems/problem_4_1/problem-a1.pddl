...
(:init
   ...
   (= (path-length start rs1_out) 17)
   (= (path-length rs1_out start) 17)
   ...
   (= (path-length rs0_in cs0_in) 24)
   (= (path-length rs0_in cs0_out) 26)
   (= (path-length rs0_out cs0_in) 23)
   (= (path-length rs0_out cs0_out) 24)
   ...
   (= (path-length cs0_in bs0_out) 7)
   (= (path-length cs0_out bs0_in) 9)
   (= (path-length cs0_out bs0_out) 8)
   (= (path-length cs0_in rs0_in) 24)
   (= (path-length cs0_in rs0_out) 23)
   (= (path-length cs0_out rs0_in) 26)
   (= (path-length cs0_out rs0_out) 24)
