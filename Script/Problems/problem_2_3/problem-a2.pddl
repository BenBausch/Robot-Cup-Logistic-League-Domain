...
(:init
   ...
   (material-required yellow_ring_p2 zero)
   (material-required black_ring_p2 zero)
   (material-required brown_ring_p2 one)
   (material-required mint_ring_p2 zero)
   ...
   (= (path-length start cs0_in) 8)
   (= (path-length cs0_in start) 8)
   (= (path-length start cs0_out) 9)
   (= (path-length cs0_out start) 9)
   ...
   (= (path-length rs0_in cs1_in) 17)
   (= (path-length rs0_in cs1_out) 16)
   (= (path-length rs0_out cs1_in) 19)
   (= (path-length rs0_out cs1_out) 17)
   (= (path-length rs0_in ds0_in) 8)
   (= (path-length rs0_out ds0_in) 8)
   (= (path-length rs1_in bs0_in) 26)
   (= (path-length rs1_in bs0_out) 25)
   (= (path-length rs1_out bs0_in) 26)
   (= (path-length rs1_out bs0_out) 26)
   (= (path-length rs1_in rs0_in) 13)
   (= (path-length rs1_in rs0_out) 12)
   ...
   (= (path-length cs1_in rs0_in) 17)
   (= (path-length cs1_in rs0_out) 19)
   (= (path-length cs1_out rs0_in) 16)
   (= (path-length cs1_out rs0_out) 17)
   (= (path-length cs1_in rs1_in) 27)
   (= (path-length cs1_in rs1_out) 29)
   (= (path-length cs1_out rs1_in) 27)
   (= (path-length cs1_out rs1_out) 27)
   (= (path-length cs1_in cs0_in) 18)
   (= (path-length cs1_in cs0_out) 19)
   (= (path-length cs1_out cs0_in) 16)
   (= (path-length cs1_out cs0_out) 18)
   ...
   (= (path-length ds0_in rs0_in) 8)
   (= (path-length ds0_in rs0_out) 8)
