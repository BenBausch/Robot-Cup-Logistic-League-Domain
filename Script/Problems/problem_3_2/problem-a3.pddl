...
(:init
   ...
   (= (path-length rs0_in cs1_in) 19)
   (= (path-length rs0_in cs1_out) 18)
   (= (path-length rs0_out cs1_in) 20)
   (= (path-length rs0_out cs1_out) 19)
   (= (path-length rs0_in ds0_in) 15)
   (= (path-length rs0_out ds0_in) 15)
   (= (path-length rs1_in bs0_in) 5)
   (= (path-length rs1_in bs0_out) 5)
   (= (path-length rs1_out bs0_in) 7)
   (= (path-length rs1_out bs0_out) 5)
   (= (path-length rs1_in rs0_in) 21)
   (= (path-length rs1_in rs0_out) 22)
   (= (path-length rs1_out rs0_in) 20)
   ...
   (= (path-length rs1_in cs1_in) 8)
   (= (path-length rs1_in cs1_out) 7)
   (= (path-length rs1_out cs1_in) 9)
   (= (path-length rs1_out cs1_out) 8)
   (= (path-length rs1_in ds0_in) 14)
   (= (path-length rs1_out ds0_in) 12)
   ...
   (= (path-length cs1_in bs0_in) 3)
   (= (path-length cs1_in bs0_out) 4)
   (= (path-length cs1_out bs0_in) 4)
   (= (path-length cs1_out bs0_out) 3)
   (= (path-length cs1_in rs0_in) 19)
   (= (path-length cs1_in rs0_out) 20)
   (= (path-length cs1_out rs0_in) 18)
   (= (path-length cs1_out rs0_out) 19)
   (= (path-length cs1_in rs1_in) 8)
   (= (path-length cs1_in rs1_out) 9)
   (= (path-length cs1_out rs1_in) 7)
   (= (path-length cs1_out rs1_out) 8)
   ...
   (= (path-length cs1_in ds0_in) 17)
   (= (path-length cs1_out ds0_in) 16)
   (= (path-length ds0_in bs0_in) 17)
   (= (path-length ds0_in bs0_out) 15)
   (= (path-length ds0_in rs0_in) 15)
   (= (path-length ds0_in rs0_out) 15)
   (= (path-length ds0_in rs1_in) 14)
   (= (path-length ds0_in rs1_out) 12)
   (= (path-length ds0_in cs0_in) 13)
   (= (path-length ds0_in cs0_out) 12)
   (= (path-length ds0_in cs1_in) 17)
   (= (path-length ds0_in cs1_out) 16)
