...
(:init
   ...
   (robot2-precedes r4)
   (robot3-precedes r4)
   (robot3-assigned-machine bs0)
   (robot3-assigned-machine rs0)
   (robot3-assigned-machine ds0)
   ...
   (= (path-length start bs0_in) 19)
   (= (path-length bs0_in start) 19)
   (= (path-length start bs0_out) 20)
   (= (path-length bs0_out start) 20)
   (= (path-length start rs0_in) 26)
   (= (path-length rs0_in start) 26)
   (= (path-length start rs0_out) 25)
   (= (path-length rs0_out start) 25)
   (= (path-length start rs1_in) 18)
   (= (path-length rs1_in start) 18)
   (= (path-length start rs1_out) 20)
   (= (path-length rs1_out start) 20)
   (= (path-length start cs0_in) 28)
   (= (path-length cs0_in start) 28)
   (= (path-length start cs0_out) 28)
   (= (path-length cs0_out start) 28)
