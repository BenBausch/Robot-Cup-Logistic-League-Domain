...
(:init
   ...
   (= (path-length start cs0_in) 14)
   (= (path-length cs0_in start) 14)
   (= (path-length start cs0_out) 14)
   (= (path-length cs0_out start) 14)
   (= (path-length start cs1_in) 13)
   (= (path-length cs1_in start) 13)
   ...
   (= (path-length rs0_in cs1_in) 20)
   (= (path-length rs0_in cs1_out) 20)
   (= (path-length rs0_out cs1_in) 20)
   (= (path-length rs0_out cs1_out) 20)
   (= (path-length rs0_in ds0_in) 2)
   (= (path-length rs0_out ds0_in) 2)
   ...
   (= (path-length cs0_in rs1_in) 3)
   (= (path-length cs0_in rs1_out) 1)
   (= (path-length cs0_out rs1_in) 4)
   (= (path-length cs0_out rs1_out) 3)
   ...
   (= (path-length cs1_in rs0_in) 20)
   (= (path-length cs1_in rs0_out) 20)
   (= (path-length cs1_out rs0_in) 20)
   (= (path-length cs1_out rs0_out) 20)
   ...
   (= (path-length ds0_in rs0_in) 2)
   (= (path-length ds0_in rs0_out) 2)
   (= (path-length ds0_in rs1_in) 15)
   (= (path-length ds0_in rs1_out) 14)
   (= (path-length ds0_in cs0_in) 15)
