...
(:init
   ...
   (= (path-length bs0_in rs1_in) 2)
   (= (path-length bs0_in rs1_out) 0)
   (= (path-length bs0_out rs1_in) 3)
   (= (path-length bs0_out rs1_out) 2)
   ...
   (= (path-length cs0_in cs1_in) 5)
   (= (path-length cs0_in cs1_out) 6)
   (= (path-length cs0_out cs1_in) 3)
   (= (path-length cs0_out cs1_out) 5)
   ...
   (= (path-length cs1_in cs0_in) 5)
   (= (path-length cs1_in cs0_out) 3)
   (= (path-length cs1_out cs0_in) 6)
   (= (path-length cs1_out cs0_out) 5)
