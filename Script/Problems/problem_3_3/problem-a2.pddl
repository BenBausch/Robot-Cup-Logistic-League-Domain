...
(:init
   ...
   (= (path-length start bs0_in) 25)
   (= (path-length bs0_in start) 25)
   ...
   (= (path-length bs0_in rs0_in) 17)
   (= (path-length bs0_in rs0_out) 15)
   (= (path-length bs0_out rs0_in) 18)
   (= (path-length bs0_out rs0_out) 17)
   (= (path-length bs0_in rs1_in) 14)
   (= (path-length bs0_in rs1_out) 13)
   (= (path-length bs0_out rs1_in) 14)
   (= (path-length bs0_out rs1_out) 14)
   (= (path-length bs0_in cs0_in) 5)
   (= (path-length bs0_in cs0_out) 5)
   (= (path-length bs0_out cs0_in) 5)
   (= (path-length bs0_out cs0_out) 5)
   (= (path-length bs0_in cs1_in) 21)
   (= (path-length bs0_in cs1_out) 20)
   (= (path-length bs0_out cs1_in) 23)
   (= (path-length bs0_out cs1_out) 21)
   (= (path-length bs0_in ds0_in) 7)
   (= (path-length bs0_out ds0_in) 8)
   (= (path-length rs0_in bs0_in) 17)
   (= (path-length rs0_in bs0_out) 18)
   (= (path-length rs0_out bs0_in) 15)
   (= (path-length rs0_out bs0_out) 17)
   ...
   (= (path-length rs0_in cs0_in) 17)
   (= (path-length rs0_in cs0_out) 18)
   (= (path-length rs0_out cs0_in) 15)
   (= (path-length rs0_out cs0_out) 17)
   (= (path-length rs0_in cs1_in) 8)
   (= (path-length rs0_in cs1_out) 7)
   (= (path-length rs0_out cs1_in) 8)
   (= (path-length rs0_out cs1_out) 8)
   (= (path-length rs0_in ds0_in) 11)
   (= (path-length rs0_out ds0_in) 9)
   (= (path-length rs1_in bs0_in) 14)
   (= (path-length rs1_in bs0_out) 14)
   (= (path-length rs1_out bs0_in) 13)
   (= (path-length rs1_out bs0_out) 14)
   ...
   (= (path-length rs1_in ds0_in) 11)
   (= (path-length rs1_out ds0_in) 11)
   (= (path-length cs0_in bs0_in) 5)
   (= (path-length cs0_in bs0_out) 5)
   (= (path-length cs0_out bs0_in) 5)
   (= (path-length cs0_out bs0_out) 5)
   (= (path-length cs0_in rs0_in) 17)
   (= (path-length cs0_in rs0_out) 15)
   (= (path-length cs0_out rs0_in) 18)
   (= (path-length cs0_out rs0_out) 17)
   ...
   (= (path-length cs0_in cs1_in) 22)
   (= (path-length cs0_in cs1_out) 21)
   (= (path-length cs0_out cs1_in) 24)
   (= (path-length cs0_out cs1_out) 22)
   (= (path-length cs0_in ds0_in) 9)
   (= (path-length cs0_out ds0_in) 10)
   (= (path-length cs1_in bs0_in) 21)
   (= (path-length cs1_in bs0_out) 23)
   (= (path-length cs1_out bs0_in) 20)
   (= (path-length cs1_out bs0_out) 21)
   (= (path-length cs1_in rs0_in) 8)
   (= (path-length cs1_in rs0_out) 8)
   (= (path-length cs1_out rs0_in) 7)
   ...
   (= (path-length cs1_in cs0_in) 22)
   (= (path-length cs1_in cs0_out) 24)
   (= (path-length cs1_out cs0_in) 21)
   (= (path-length cs1_out cs0_out) 22)
   ...
   (= (path-length ds0_in bs0_in) 7)
   (= (path-length ds0_in bs0_out) 8)
   (= (path-length ds0_in rs0_in) 11)
   (= (path-length ds0_in rs0_out) 9)
   (= (path-length ds0_in rs1_in) 11)
   (= (path-length ds0_in rs1_out) 11)
   (= (path-length ds0_in cs0_in) 9)
   (= (path-length ds0_in cs0_out) 10)
