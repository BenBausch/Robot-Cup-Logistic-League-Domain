...
(:init
   ...
   (step-at-machine gray_cap_p2 cs1)
   ...
   (= (path-length start rs1_in) 25)
   (= (path-length rs1_in start) 25)
   ...
   (= (path-length start cs1_in) 24)
   (= (path-length cs1_in start) 24)
   (= (path-length start cs1_out) 24)
   (= (path-length cs1_out start) 24)
   ...
   (= (path-length bs0_in rs0_in) 22)
   (= (path-length bs0_in rs0_out) 23)
   (= (path-length bs0_out rs0_in) 21)
   (= (path-length bs0_out rs0_out) 22)
   (= (path-length bs0_in rs1_in) 10)
   (= (path-length bs0_in rs1_out) 11)
   (= (path-length bs0_out rs1_in) 8)
   (= (path-length bs0_out rs1_out) 10)
   (= (path-length bs0_in cs0_in) 30)
   (= (path-length bs0_in cs0_out) 32)
   (= (path-length bs0_out cs0_in) 29)
   (= (path-length bs0_out cs0_out) 30)
   (= (path-length bs0_in cs1_in) 27)
   (= (path-length bs0_in cs1_out) 28)
   (= (path-length bs0_out cs1_in) 25)
   (= (path-length bs0_out cs1_out) 27)
   (= (path-length bs0_in ds0_in) 18)
   (= (path-length bs0_out ds0_in) 17)
   (= (path-length rs0_in bs0_in) 22)
   (= (path-length rs0_in bs0_out) 21)
   (= (path-length rs0_out bs0_in) 23)
   (= (path-length rs0_out bs0_out) 22)
   (= (path-length rs0_in rs0_in) 0)
   (= (path-length rs0_in rs0_out) 2)
   (= (path-length rs0_out rs0_in) 2)
   (= (path-length rs0_out rs0_out) 0)
   (= (path-length rs0_in rs1_in) 13)
   (= (path-length rs0_in rs1_out) 12)
   (= (path-length rs0_out rs1_in) 14)
   (= (path-length rs0_out rs1_out) 13)
   (= (path-length rs0_in cs0_in) 9)
   (= (path-length rs0_in cs0_out) 10)
   (= (path-length rs0_out cs0_in) 8)
   (= (path-length rs0_out cs0_out) 9)
   (= (path-length rs0_in cs1_in) 7)
   (= (path-length rs0_in cs1_out) 8)
   (= (path-length rs0_out cs1_in) 6)
   (= (path-length rs0_out cs1_out) 7)
   ...
   (= (path-length rs1_in rs0_in) 13)
   (= (path-length rs1_in rs0_out) 14)
   (= (path-length rs1_out rs0_in) 12)
   (= (path-length rs1_out rs0_out) 13)
   ...
   (= (path-length rs1_out cs1_in) 16)
   (= (path-length rs1_out cs1_out) 18)
   (= (path-length rs1_in ds0_in) 10)
   (= (path-length rs1_out ds0_in) 9)
   (= (path-length cs0_in bs0_in) 30)
   (= (path-length cs0_in bs0_out) 29)
   (= (path-length cs0_out bs0_in) 32)
   (= (path-length cs0_out bs0_out) 30)
   ...
   (= (path-length cs0_in cs1_in) 7)
   (= (path-length cs0_in cs1_out) 7)
   (= (path-length cs0_out cs1_in) 8)
   (= (path-length cs0_out cs1_out) 7)
   (= (path-length cs0_in ds0_in) 13)
   (= (path-length cs0_out ds0_in) 14)
   (= (path-length cs1_in bs0_in) 27)
   (= (path-length cs1_in bs0_out) 25)
   (= (path-length cs1_out bs0_in) 28)
   (= (path-length cs1_out bs0_out) 27)
   (= (path-length cs1_in rs0_in) 7)
   (= (path-length cs1_in rs0_out) 6)
   (= (path-length cs1_out rs0_in) 8)
   (= (path-length cs1_out rs0_out) 7)
   (= (path-length cs1_in rs1_in) 18)
   (= (path-length cs1_in rs1_out) 16)
   (= (path-length cs1_out rs1_in) 19)
   (= (path-length cs1_out rs1_out) 18)
   (= (path-length cs1_in cs0_in) 7)
   (= (path-length cs1_in cs0_out) 8)
   (= (path-length cs1_out cs0_in) 7)
   (= (path-length cs1_out cs0_out) 7)
