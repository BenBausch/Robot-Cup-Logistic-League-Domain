...
(:init
   ...
   (material-required blue_base_p2 two)
   (material-required gray_ring_p2 three)
   ...
   (= (path-length start rs0_in) 33)
   (= (path-length rs0_in start) 33)
   (= (path-length start rs0_out) 33)
   (= (path-length rs0_out start) 33)
   (= (path-length start rs1_in) 14)
   (= (path-length rs1_in start) 14)
   (= (path-length start rs1_out) 15)
   (= (path-length rs1_out start) 15)
   (= (path-length start cs0_in) 12)
   (= (path-length cs0_in start) 12)
   (= (path-length start cs0_out) 12)
   (= (path-length cs0_out start) 12)
   ...
   (= (path-length rs1_in cs0_out) 3)
   (= (path-length rs1_out cs0_in) 6)
   (= (path-length rs1_out cs0_out) 5)
   (= (path-length rs1_in cs1_in) 11)
   (= (path-length rs1_in cs1_out) 12)
   (= (path-length rs1_out cs1_in) 10)
   (= (path-length rs1_out cs1_out) 11)
   (= (path-length rs1_in ds0_in) 5)
   (= (path-length rs1_out ds0_in) 6)
   (= (path-length cs0_in bs0_in) 4)
   (= (path-length cs0_in bs0_out) 4)
   (= (path-length cs0_out bs0_in) 5)
   (= (path-length cs0_out bs0_out) 4)
   (= (path-length cs0_in rs0_in) 23)
   (= (path-length cs0_in rs0_out) 22)
   (= (path-length cs0_out rs0_in) 23)
   (= (path-length cs0_out rs0_out) 23)
   (= (path-length cs0_in rs1_in) 5)
   (= (path-length cs0_in rs1_out) 6)
   (= (path-length cs0_out rs1_in) 3)
   ...
   (= (path-length cs1_in rs1_in) 11)
   (= (path-length cs1_in rs1_out) 10)
   (= (path-length cs1_out rs1_in) 12)
   (= (path-length cs1_out rs1_out) 11)
   (= (path-length cs1_in cs0_in) 14)
   (= (path-length cs1_in cs0_out) 12)
   (= (path-length cs1_out cs0_in) 15)
