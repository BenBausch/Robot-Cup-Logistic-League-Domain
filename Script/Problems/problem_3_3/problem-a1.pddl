...
(:init
   ...
   (= (path-length start rs0_out) 20)
   (= (path-length rs0_out start) 20)
   (= (path-length start rs1_in) 26)
   (= (path-length rs1_in start) 26)
   (= (path-length start rs1_out) 25)
   (= (path-length rs1_out start) 25)
   ...
   (= (path-length start ds0_in) 20)
   (= (path-length ds0_in start) 20)
