...
(:init
   ...
   (= (path-length start bs0_in) 32)
   (= (path-length bs0_in start) 32)
   (= (path-length start bs0_out) 32)
   (= (path-length bs0_out start) 32)
   ...
   (= (path-length start cs0_in) 11)
   (= (path-length cs0_in start) 11)
   (= (path-length start cs0_out) 10)
   (= (path-length cs0_out start) 10)
   ...
   (= (path-length bs0_in cs1_in) 23)
   (= (path-length bs0_in cs1_out) 22)
   (= (path-length bs0_out cs1_in) 24)
   (= (path-length bs0_out cs1_out) 23)
   (= (path-length bs0_in ds0_in) 25)
   (= (path-length bs0_out ds0_in) 26)
   (= (path-length rs0_in bs0_in) 13)
   (= (path-length rs0_in bs0_out) 15)
   ...
   (= (path-length rs0_out rs1_in) 13)
   (= (path-length rs0_out rs1_out) 13)
   (= (path-length rs0_in cs0_in) 12)
   (= (path-length rs0_in cs0_out) 11)
   (= (path-length rs0_out cs0_in) 12)
   (= (path-length rs0_out cs0_out) 12)
   (= (path-length rs0_in cs1_in) 10)
   (= (path-length rs0_in cs1_out) 9)
   (= (path-length rs0_out cs1_in) 11)
   (= (path-length rs0_out cs1_out) 10)
   ...
   (= (path-length rs1_in cs0_out) 6)
   (= (path-length rs1_out cs0_in) 4)
   (= (path-length rs1_out cs0_out) 5)
   (= (path-length rs1_in cs1_in) 5)
   (= (path-length rs1_in cs1_out) 5)
   (= (path-length rs1_out cs1_in) 6)
   (= (path-length rs1_out cs1_out) 5)
   (= (path-length rs1_in ds0_in) 3)
   (= (path-length rs1_out ds0_in) 1)
   (= (path-length cs0_in bs0_in) 24)
   (= (path-length cs0_in bs0_out) 25)
   (= (path-length cs0_out bs0_in) 23)
   (= (path-length cs0_out bs0_out) 24)
   (= (path-length cs0_in rs0_in) 12)
   (= (path-length cs0_in rs0_out) 12)
   (= (path-length cs0_out rs0_in) 11)
   (= (path-length cs0_out rs0_out) 12)
   (= (path-length cs0_in rs1_in) 5)
   (= (path-length cs0_in rs1_out) 4)
   (= (path-length cs0_out rs1_in) 6)
   ...
   (= (path-length cs1_in bs0_in) 23)
   (= (path-length cs1_in bs0_out) 24)
   (= (path-length cs1_out bs0_in) 22)
   (= (path-length cs1_out bs0_out) 23)
   (= (path-length cs1_in rs0_in) 10)
   (= (path-length cs1_in rs0_out) 11)
   (= (path-length cs1_out rs0_in) 9)
   (= (path-length cs1_out rs0_out) 10)
   (= (path-length cs1_in rs1_in) 5)
   (= (path-length cs1_in rs1_out) 6)
   (= (path-length cs1_out rs1_in) 5)
   (= (path-length cs1_out rs1_out) 5)
   ...
   (= (path-length cs1_out ds0_in) 6)
   (= (path-length ds0_in bs0_in) 25)
   (= (path-length ds0_in bs0_out) 26)
   (= (path-length ds0_in rs0_in) 12)
   (= (path-length ds0_in rs0_out) 13)
   (= (path-length ds0_in rs1_in) 3)
   (= (path-length ds0_in rs1_out) 1)
   (= (path-length ds0_in cs0_in) 3)
   (= (path-length ds0_in cs0_out) 4)
   (= (path-length ds0_in cs1_in) 7)
   (= (path-length ds0_in cs1_out) 6)
