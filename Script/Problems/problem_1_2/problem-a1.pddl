...
(:init
   ...
   (= (path-length start bs0_in) 6)
   (= (path-length bs0_in start) 6)
   (= (path-length start bs0_out) 5)
   (= (path-length bs0_out start) 5)
   ...
   (= (path-length bs0_in rs1_in) 20)
   (= (path-length bs0_in rs1_out) 20)
   (= (path-length bs0_out rs1_in) 20)
   (= (path-length bs0_out rs1_out) 20)
   (= (path-length bs0_in cs0_in) 19)
   (= (path-length bs0_in cs0_out) 18)
   ...
   (= (path-length cs0_out cs1_in) 7)
   (= (path-length cs0_out cs1_out) 7)
   (= (path-length cs0_in ds0_in) 23)
