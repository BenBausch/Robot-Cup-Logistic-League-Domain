...
(:init
   ...
   (robot2-assigned-machine cs0)
   (robot2-assigned-machine ds0)
   ...
   (= (path-length start bs0_in) 37)
   (= (path-length bs0_in start) 37)
   (= (path-length start bs0_out) 37)
   (= (path-length bs0_out start) 37)
   ...
   (= (path-length start rs1_out) 21)
   (= (path-length rs1_out start) 21)
