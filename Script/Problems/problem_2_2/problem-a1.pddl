...
(:init
   ...
   (= (path-length start bs0_in) 38)
   (= (path-length bs0_in start) 38)
   (= (path-length start bs0_out) 38)
   (= (path-length bs0_out start) 38)
   (= (path-length start rs0_in) 13)
   (= (path-length rs0_in start) 13)
   (= (path-length start rs0_out) 14)
   (= (path-length rs0_out start) 14)
   (= (path-length start rs1_in) 23)
   (= (path-length rs1_in start) 23)
   (= (path-length start rs1_out) 22)
   (= (path-length rs1_out start) 22)
   (= (path-length start cs0_in) 24)
   (= (path-length cs0_in start) 24)
   ...
   (= (path-length bs0_in rs0_in) 27)
   (= (path-length bs0_in rs0_out) 27)
   (= (path-length bs0_out rs0_in) 27)
   (= (path-length bs0_out rs0_out) 27)
   (= (path-length bs0_in rs1_in) 25)
   (= (path-length bs0_in rs1_out) 24)
   (= (path-length bs0_out rs1_in) 26)
   (= (path-length bs0_out rs1_out) 25)
   (= (path-length bs0_in cs0_in) 16)
   (= (path-length bs0_in cs0_out) 16)
   (= (path-length bs0_out cs0_in) 17)
   (= (path-length bs0_out cs0_out) 16)
   (= (path-length bs0_in cs1_in) 15)
   (= (path-length bs0_in cs1_out) 15)
   (= (path-length bs0_out cs1_in) 15)
   (= (path-length bs0_out cs1_out) 15)
   (= (path-length bs0_in ds0_in) 23)
   (= (path-length bs0_out ds0_in) 23)
   (= (path-length rs0_in bs0_in) 27)
   (= (path-length rs0_in bs0_out) 27)
   (= (path-length rs0_out bs0_in) 27)
   (= (path-length rs0_out bs0_out) 27)
   ...
   (= (path-length rs0_in rs1_out) 19)
   (= (path-length rs0_out rs1_in) 22)
   (= (path-length rs0_out rs1_out) 21)
   (= (path-length rs0_in cs0_in) 16)
   (= (path-length rs0_in cs0_out) 15)
   (= (path-length rs0_out cs0_in) 16)
   (= (path-length rs0_out cs0_out) 16)
   ...
   (= (path-length rs1_in bs0_in) 25)
   (= (path-length rs1_in bs0_out) 26)
   (= (path-length rs1_out bs0_in) 24)
   (= (path-length rs1_out bs0_out) 25)
   (= (path-length rs1_in rs0_in) 21)
   (= (path-length rs1_in rs0_out) 22)
   (= (path-length rs1_out rs0_in) 19)
   ...
   (= (path-length rs1_in cs0_in) 11)
   (= (path-length rs1_in cs0_out) 12)
   (= (path-length rs1_out cs0_in) 10)
   (= (path-length rs1_out cs0_out) 11)
   (= (path-length rs1_in cs1_in) 17)
   (= (path-length rs1_in cs1_out) 18)
   (= (path-length rs1_out cs1_in) 16)
   (= (path-length rs1_out cs1_out) 17)
   ...
   (= (path-length cs0_in rs0_in) 16)
   (= (path-length cs0_in rs0_out) 16)
   (= (path-length cs0_out rs0_in) 15)
   (= (path-length cs0_out rs0_out) 16)
   (= (path-length cs0_in rs1_in) 11)
   (= (path-length cs0_in rs1_out) 10)
   (= (path-length cs0_out rs1_in) 12)
   (= (path-length cs0_out rs1_out) 11)
   ...
   (= (path-length ds0_in bs0_in) 23)
   (= (path-length ds0_in bs0_out) 23)
