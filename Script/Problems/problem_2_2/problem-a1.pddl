...
(:init
   ...
   (= (path-length bs0_out rs1_in) 9)
   (= (path-length bs0_out rs1_out) 10)
   (= (path-length bs0_in cs0_in) 21)
   (= (path-length bs0_in cs0_out) 22)
   (= (path-length bs0_out cs0_in) 20)
   (= (path-length bs0_out cs0_out) 21)
   (= (path-length bs0_in cs1_in) 13)
   (= (path-length bs0_in cs1_out) 15)
   (= (path-length bs0_out cs1_in) 12)
   (= (path-length bs0_out cs1_out) 13)
   (= (path-length bs0_in ds0_in) 14)
   ...
   (= (path-length rs0_in cs0_in) 1)
   (= (path-length rs0_in cs0_out) 1)
   (= (path-length rs0_out cs0_in) 3)
   (= (path-length rs0_out cs0_out) 1)
   (= (path-length rs0_in cs1_in) 9)
   (= (path-length rs0_in cs1_out) 8)
   (= (path-length rs0_out cs1_in) 10)
   (= (path-length rs0_out cs1_out) 9)
   (= (path-length rs0_in ds0_in) 9)
   (= (path-length rs0_out ds0_in) 10)
   (= (path-length rs1_in bs0_in) 10)
   (= (path-length rs1_in bs0_out) 9)
   ...
   (= (path-length rs1_in cs1_in) 3)
   (= (path-length rs1_in cs1_out) 5)
   (= (path-length rs1_out cs1_in) 2)
   (= (path-length rs1_out cs1_out) 3)
   (= (path-length rs1_in ds0_in) 5)
   (= (path-length rs1_out ds0_in) 3)
   (= (path-length cs0_in bs0_in) 21)
   (= (path-length cs0_in bs0_out) 20)
   (= (path-length cs0_out bs0_in) 22)
   (= (path-length cs0_out bs0_out) 21)
   (= (path-length cs0_in rs0_in) 1)
   (= (path-length cs0_in rs0_out) 3)
   (= (path-length cs0_out rs0_in) 1)
   (= (path-length cs0_out rs0_out) 1)
   ...
   (= (path-length cs1_in bs0_out) 12)
   (= (path-length cs1_out bs0_in) 15)
   (= (path-length cs1_out bs0_out) 13)
   (= (path-length cs1_in rs0_in) 9)
   (= (path-length cs1_in rs0_out) 10)
   (= (path-length cs1_out rs0_in) 8)
   (= (path-length cs1_out rs0_out) 9)
   (= (path-length cs1_in rs1_in) 3)
   (= (path-length cs1_in rs1_out) 2)
   (= (path-length cs1_out rs1_in) 5)
   (= (path-length cs1_out rs1_out) 3)
