...
(:init
   ...
   (= (path-length start rs0_in) 37)
   (= (path-length rs0_in start) 37)
   (= (path-length start rs0_out) 37)
   (= (path-length rs0_out start) 37)
   (= (path-length start rs1_in) 28)
   (= (path-length rs1_in start) 28)
