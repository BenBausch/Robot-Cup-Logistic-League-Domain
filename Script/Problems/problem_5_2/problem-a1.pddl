...
(:init
   ...
   (= (path-length start rs0_in) 7)
   (= (path-length rs0_in start) 7)
   (= (path-length start rs0_out) 7)
   (= (path-length rs0_out start) 7)
   ...
   (= (path-length start ds0_in) 17)
   (= (path-length ds0_in start) 17)
