...
(:init
   ...
   (= (path-length start bs0_in) 18)
   (= (path-length bs0_in start) 18)
   (= (path-length start bs0_out) 17)
   (= (path-length bs0_out start) 17)
   (= (path-length start rs0_in) 30)
   (= (path-length rs0_in start) 30)
   (= (path-length start rs0_out) 30)
   (= (path-length rs0_out start) 30)
   (= (path-length start rs1_in) 14)
   (= (path-length rs1_in start) 14)
