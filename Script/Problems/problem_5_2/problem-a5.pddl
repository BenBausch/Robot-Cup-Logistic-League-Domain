...
(:init
   ...
   (robot3-precedes r5)
   (robot4-precedes r5)
   (robot5-assigned-machine rs1)
   (robot5-assigned-machine ds0)
   ...
   (= (path-length start rs0_in) 27)
   (= (path-length rs0_in start) 27)
   (= (path-length start rs0_out) 27)
   (= (path-length rs0_out start) 27)
   (= (path-length start rs1_in) 11)
   (= (path-length rs1_in start) 11)
   (= (path-length start rs1_out) 11)
   (= (path-length rs1_out start) 11)
   (= (path-length start cs0_in) 3)
   (= (path-length cs0_in start) 3)
   (= (path-length start cs0_out) 4)
   (= (path-length cs0_out start) 4)
   (= (path-length start cs1_in) 29)
   (= (path-length cs1_in start) 29)
   (= (path-length start cs1_out) 28)
   (= (path-length cs1_out start) 28)
   (= (path-length start ds0_in) 32)
   (= (path-length ds0_in start) 32)
   (= (path-length bs0_in bs0_in) 0)
   (= (path-length bs0_in bs0_out) 2)
   (= (path-length bs0_out bs0_in) 2)
   (= (path-length bs0_out bs0_out) 0)
   (= (path-length bs0_in rs0_in) 18)
   (= (path-length bs0_in rs0_out) 19)
   (= (path-length bs0_out rs0_in) 17)
   (= (path-length bs0_out rs0_out) 18)
   (= (path-length bs0_in rs1_in) 9)
   (= (path-length bs0_in rs1_out) 10)
   (= (path-length bs0_out rs1_in) 8)
   (= (path-length bs0_out rs1_out) 9)
   (= (path-length bs0_in cs0_in) 16)
   (= (path-length bs0_in cs0_out) 16)
   (= (path-length bs0_out cs0_in) 15)
   (= (path-length bs0_out cs0_out) 16)
   (= (path-length bs0_in cs1_in) 18)
   (= (path-length bs0_in cs1_out) 18)
   (= (path-length bs0_out cs1_in) 18)
   (= (path-length bs0_out cs1_out) 18)
   (= (path-length bs0_in ds0_in) 22)
   (= (path-length bs0_out ds0_in) 22)
   (= (path-length rs0_in bs0_in) 18)
   (= (path-length rs0_in bs0_out) 17)
   (= (path-length rs0_out bs0_in) 19)
   (= (path-length rs0_out bs0_out) 18)
   (= (path-length rs0_in rs0_in) 0)
   (= (path-length rs0_in rs0_out) 2)
   (= (path-length rs0_out rs0_in) 2)
   (= (path-length rs0_out rs0_out) 0)
   (= (path-length rs0_in rs1_in) 17)
   (= (path-length rs0_in rs1_out) 17)
   (= (path-length rs0_out rs1_in) 17)
   (= (path-length rs0_out rs1_out) 17)
   (= (path-length rs0_in cs0_in) 28)
   (= (path-length rs0_in cs0_out) 29)
   (= (path-length rs0_out cs0_in) 28)
   (= (path-length rs0_out cs0_out) 28)
   (= (path-length rs0_in cs1_in) 4)
   (= (path-length rs0_in cs1_out) 3)
   (= (path-length rs0_out cs1_in) 5)
   (= (path-length rs0_out cs1_out) 4)
   (= (path-length rs0_in ds0_in) 5)
   (= (path-length rs0_out ds0_in) 5)
   (= (path-length rs1_in bs0_in) 9)
   (= (path-length rs1_in bs0_out) 8)
   (= (path-length rs1_out bs0_in) 10)
   (= (path-length rs1_out bs0_out) 9)
   (= (path-length rs1_in rs0_in) 17)
   (= (path-length rs1_in rs0_out) 17)
   (= (path-length rs1_out rs0_in) 17)
   (= (path-length rs1_out rs0_out) 17)
   (= (path-length rs1_in rs1_in) 0)
   (= (path-length rs1_in rs1_out) 2)
   (= (path-length rs1_out rs1_in) 2)
   (= (path-length rs1_out rs1_out) 0)
   (= (path-length rs1_in cs0_in) 12)
   (= (path-length rs1_in cs0_out) 12)
   (= (path-length rs1_out cs0_in) 12)
   (= (path-length rs1_out cs0_out) 12)
   (= (path-length rs1_in cs1_in) 18)
   (= (path-length rs1_in cs1_out) 18)
   (= (path-length rs1_out cs1_in) 19)
   (= (path-length rs1_out cs1_out) 18)
   (= (path-length rs1_in ds0_in) 21)
   (= (path-length rs1_out ds0_in) 21)
   (= (path-length cs0_in bs0_in) 16)
   (= (path-length cs0_in bs0_out) 15)
   (= (path-length cs0_out bs0_in) 16)
   (= (path-length cs0_out bs0_out) 16)
   (= (path-length cs0_in rs0_in) 28)
   (= (path-length cs0_in rs0_out) 28)
   (= (path-length cs0_out rs0_in) 29)
   (= (path-length cs0_out rs0_out) 28)
   (= (path-length cs0_in rs1_in) 12)
   (= (path-length cs0_in rs1_out) 12)
   (= (path-length cs0_out rs1_in) 12)
   (= (path-length cs0_out rs1_out) 12)
   (= (path-length cs0_in cs0_in) 0)
   (= (path-length cs0_in cs0_out) 2)
   (= (path-length cs0_out cs0_in) 2)
   (= (path-length cs0_out cs0_out) 0)
   (= (path-length cs0_in cs1_in) 30)
   (= (path-length cs0_in cs1_out) 29)
   (= (path-length cs0_out cs1_in) 30)
   (= (path-length cs0_out cs1_out) 30)
   (= (path-length cs0_in ds0_in) 32)
   (= (path-length cs0_out ds0_in) 33)
   (= (path-length cs1_in bs0_in) 18)
   (= (path-length cs1_in bs0_out) 18)
   (= (path-length cs1_out bs0_in) 18)
   (= (path-length cs1_out bs0_out) 18)
   (= (path-length cs1_in rs0_in) 4)
   (= (path-length cs1_in rs0_out) 5)
   (= (path-length cs1_out rs0_in) 3)
   (= (path-length cs1_out rs0_out) 4)
   (= (path-length cs1_in rs1_in) 18)
   (= (path-length cs1_in rs1_out) 19)
   (= (path-length cs1_out rs1_in) 18)
   (= (path-length cs1_out rs1_out) 18)
   (= (path-length cs1_in cs0_in) 30)
   (= (path-length cs1_in cs0_out) 30)
   (= (path-length cs1_out cs0_in) 29)
   (= (path-length cs1_out cs0_out) 30)
   (= (path-length cs1_in cs1_in) 0)
   (= (path-length cs1_in cs1_out) 2)
   (= (path-length cs1_out cs1_in) 2)
   (= (path-length cs1_out cs1_out) 0)
   (= (path-length cs1_in ds0_in) 7)
   (= (path-length cs1_out ds0_in) 5)
   (= (path-length ds0_in bs0_in) 22)
   (= (path-length ds0_in bs0_out) 22)
   (= (path-length ds0_in rs0_in) 5)
   (= (path-length ds0_in rs0_out) 5)
   (= (path-length ds0_in rs1_in) 21)
   (= (path-length ds0_in rs1_out) 21)
   (= (path-length ds0_in cs0_in) 32)
   (= (path-length ds0_in cs0_out) 33)
   (= (path-length ds0_in cs1_in) 7)
   (= (path-length ds0_in cs1_out) 5)
