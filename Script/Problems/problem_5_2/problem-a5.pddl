...
(:init
   ...
   (= (path-length start rs0_in) 5)
   (= (path-length rs0_in start) 5)
   (= (path-length start rs0_out) 5)
   (= (path-length rs0_out start) 5)
   ...
   (= (path-length bs0_in rs0_in) 12)
   (= (path-length bs0_in rs0_out) 11)
   (= (path-length bs0_out rs0_in) 13)
   (= (path-length bs0_out rs0_out) 12)
   (= (path-length bs0_in rs1_in) 23)
   (= (path-length bs0_in rs1_out) 22)
   (= (path-length bs0_out rs1_in) 24)
   (= (path-length bs0_out rs1_out) 23)
   (= (path-length bs0_in cs0_in) 12)
   (= (path-length bs0_in cs0_out) 12)
   ...
   (= (path-length rs0_in bs0_in) 12)
   (= (path-length rs0_in bs0_out) 13)
   (= (path-length rs0_out bs0_in) 11)
   (= (path-length rs0_out bs0_out) 12)
   ...
   (= (path-length rs0_in cs0_in) 18)
   (= (path-length rs0_in cs0_out) 18)
   (= (path-length rs0_out cs0_in) 18)
   (= (path-length rs0_out cs0_out) 18)
   ...
   (= (path-length rs1_in bs0_in) 23)
   (= (path-length rs1_in bs0_out) 24)
   (= (path-length rs1_out bs0_in) 22)
   (= (path-length rs1_out bs0_out) 23)
   ...
   (= (path-length cs0_out bs0_in) 12)
   (= (path-length cs0_out bs0_out) 12)
   (= (path-length cs0_in rs0_in) 18)
   (= (path-length cs0_in rs0_out) 18)
   (= (path-length cs0_out rs0_in) 18)
   (= (path-length cs0_out rs0_out) 18)
   ...
   (= (path-length cs0_in cs1_in) 4)
   (= (path-length cs0_in cs1_out) 5)
   (= (path-length cs0_out cs1_in) 2)
   (= (path-length cs0_out cs1_out) 4)
   (= (path-length cs0_in ds0_in) 16)
   (= (path-length cs0_out ds0_in) 17)
   ...
   (= (path-length cs1_in cs0_in) 4)
   (= (path-length cs1_in cs0_out) 2)
   (= (path-length cs1_out cs0_in) 5)
   (= (path-length cs1_out cs0_out) 4)
   ...
   (= (path-length ds0_in cs0_in) 16)
   (= (path-length ds0_in cs0_out) 17)
   (= (path-length ds0_in cs1_in) 17)
   (= (path-length ds0_in cs1_out) 19)
