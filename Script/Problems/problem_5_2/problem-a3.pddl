...
(:init
   ...
   (= (path-length start bs0_in) 16)
   (= (path-length bs0_in start) 16)
   (= (path-length start bs0_out) 15)
   (= (path-length bs0_out start) 15)
   ...
   (= (path-length start cs0_in) 1)
   (= (path-length cs0_in start) 1)
   ...
   (= (path-length start ds0_in) 33)
   (= (path-length ds0_in start) 33)
