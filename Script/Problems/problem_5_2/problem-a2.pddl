...
(:init
   ...
   (= (path-length start bs0_in) 17)
   (= (path-length bs0_in start) 17)
   (= (path-length start bs0_out) 16)
   (= (path-length bs0_out start) 16)
   (= (path-length start rs0_in) 30)
   (= (path-length rs0_in start) 30)
   (= (path-length start rs0_out) 30)
   (= (path-length rs0_out start) 30)
   (= (path-length start rs1_in) 13)
   (= (path-length rs1_in start) 13)
   (= (path-length start rs1_out) 13)
   (= (path-length rs1_out start) 13)
   (= (path-length start cs0_in) 2)
   (= (path-length cs0_in start) 2)
   (= (path-length start cs0_out) 2)
   (= (path-length cs0_out start) 2)
   (= (path-length start cs1_in) 31)
   (= (path-length cs1_in start) 31)
   (= (path-length start cs1_out) 31)
   (= (path-length cs1_out start) 31)
   (= (path-length start ds0_in) 34)
   (= (path-length ds0_in start) 34)
