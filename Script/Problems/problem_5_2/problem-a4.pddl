...
(:init
   ...
   (= (path-length start bs0_in) 15)
   (= (path-length bs0_in start) 15)
   (= (path-length start bs0_out) 14)
   (= (path-length bs0_out start) 14)
   (= (path-length start rs0_in) 28)
   (= (path-length rs0_in start) 28)
   (= (path-length start rs0_out) 28)
   (= (path-length rs0_out start) 28)
   (= (path-length start rs1_in) 12)
   (= (path-length rs1_in start) 12)
   (= (path-length start rs1_out) 12)
   (= (path-length rs1_out start) 12)
