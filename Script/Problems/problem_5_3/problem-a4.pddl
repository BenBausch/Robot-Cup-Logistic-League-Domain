...
(:init
   ...
   (= (path-length start bs0_in) 11)
   (= (path-length bs0_in start) 11)
   ...
   (= (path-length start rs1_in) 21)
   (= (path-length rs1_in start) 21)
   ...
   (= (path-length start cs1_in) 31)
   (= (path-length cs1_in start) 31)
   (= (path-length start cs1_out) 30)
   (= (path-length cs1_out start) 30)
   (= (path-length start ds0_in) 6)
   (= (path-length ds0_in start) 6)
