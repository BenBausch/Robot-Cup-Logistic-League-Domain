...
(:init
   ...
   (= (path-length start rs0_out) 18)
   (= (path-length rs0_out start) 18)
   ...
   (= (path-length start cs1_in) 33)
   (= (path-length cs1_in start) 33)
   (= (path-length start cs1_out) 33)
   (= (path-length cs1_out start) 33)
   (= (path-length start ds0_in) 9)
   (= (path-length ds0_in start) 9)
