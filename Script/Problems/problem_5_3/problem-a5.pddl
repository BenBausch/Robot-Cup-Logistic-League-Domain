...
(:init
   ...
   (robot3-precedes r5)
   (robot4-precedes r5)
   (robot5-assigned-machine rs0)
   (robot5-assigned-machine cs1)
   ...
   (= (path-length start rs0_in) 15)
   (= (path-length rs0_in start) 15)
   ...
   (= (path-length start ds0_in) 5)
   (= (path-length ds0_in start) 5)
