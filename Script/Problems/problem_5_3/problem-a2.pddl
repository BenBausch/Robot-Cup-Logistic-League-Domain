...
(:init
   ...
   (step-at-machine purple_ring_p2 rs1)
   (step-at-machine yellow_ring_p2 rs1)
   (step-at-machine black_ring_p2 rs1)
   (step-at-machine green_ring_p2 rs0)
   ...
   (material-required blue_base_p2 one)
   (material-required blue_ring_p1 one)
   (material-required gray_ring_p2 zero)
   (material-required green_ring_p2 one)
   ...
   (= (path-length start bs0_in) 12)
   (= (path-length bs0_in start) 12)
   (= (path-length start bs0_out) 13)
   (= (path-length bs0_out start) 13)
   (= (path-length start rs0_in) 18)
   (= (path-length rs0_in start) 18)
   (= (path-length start rs0_out) 17)
   (= (path-length rs0_out start) 17)
   (= (path-length start rs1_in) 22)
   (= (path-length rs1_in start) 22)
   (= (path-length start rs1_out) 23)
   (= (path-length rs1_out start) 23)
   (= (path-length start cs0_in) 19)
   (= (path-length cs0_in start) 19)
   (= (path-length start cs0_out) 19)
   (= (path-length cs0_out start) 19)
   (= (path-length start cs1_in) 32)
   (= (path-length cs1_in start) 32)
   (= (path-length start cs1_out) 32)
   (= (path-length cs1_out start) 32)
   (= (path-length start ds0_in) 8)
   (= (path-length ds0_in start) 8)
   ...
   (= (path-length bs0_in rs0_out) 17)
   (= (path-length bs0_out rs0_in) 20)
   (= (path-length bs0_out rs0_out) 19)
   (= (path-length bs0_in rs1_in) 10)
   (= (path-length bs0_in rs1_out) 12)
   (= (path-length bs0_out rs1_in) 10)
   (= (path-length bs0_out rs1_out) 10)
   (= (path-length bs0_in cs0_in) 11)
   (= (path-length bs0_in cs0_out) 10)
   (= (path-length bs0_out cs0_in) 12)
   (= (path-length bs0_out cs0_out) 11)
   (= (path-length bs0_in cs1_in) 27)
   (= (path-length bs0_in cs1_out) 26)
   (= (path-length bs0_out cs1_in) 28)
   (= (path-length bs0_out cs1_out) 27)
   (= (path-length bs0_in ds0_in) 10)
   (= (path-length bs0_out ds0_in) 11)
   (= (path-length rs0_in bs0_in) 19)
   (= (path-length rs0_in bs0_out) 20)
   (= (path-length rs0_out bs0_in) 17)
   ...
   (= (path-length rs0_in rs1_in) 25)
   (= (path-length rs0_in rs1_out) 27)
   (= (path-length rs0_out rs1_in) 24)
   (= (path-length rs0_out rs1_out) 25)
   (= (path-length rs0_in cs0_in) 14)
   (= (path-length rs0_in cs0_out) 16)
   (= (path-length rs0_out cs0_in) 13)
   (= (path-length rs0_out cs0_out) 14)
   (= (path-length rs0_in cs1_in) 18)
   (= (path-length rs0_in cs1_out) 19)
   (= (path-length rs0_out cs1_in) 18)
   (= (path-length rs0_out cs1_out) 18)
   (= (path-length rs0_in ds0_in) 11)
   (= (path-length rs0_out ds0_in) 10)
   (= (path-length rs1_in bs0_in) 10)
   (= (path-length rs1_in bs0_out) 10)
   (= (path-length rs1_out bs0_in) 12)
   (= (path-length rs1_out bs0_out) 10)
   (= (path-length rs1_in rs0_in) 25)
   (= (path-length rs1_in rs0_out) 24)
   (= (path-length rs1_out rs0_in) 27)
   (= (path-length rs1_out rs0_out) 25)
   ...
   (= (path-length rs1_in cs0_out) 11)
   (= (path-length rs1_out cs0_in) 14)
   (= (path-length rs1_out cs0_out) 13)
   (= (path-length rs1_in cs1_in) 27)
   (= (path-length rs1_in cs1_out) 26)
   (= (path-length rs1_out cs1_in) 28)
   (= (path-length rs1_out cs1_out) 27)
   (= (path-length rs1_in ds0_in) 19)
   (= (path-length rs1_out ds0_in) 20)
   (= (path-length cs0_in bs0_in) 11)
   (= (path-length cs0_in bs0_out) 12)
   (= (path-length cs0_out bs0_in) 10)
   (= (path-length cs0_out bs0_out) 11)
   (= (path-length cs0_in rs0_in) 14)
   (= (path-length cs0_in rs0_out) 13)
   (= (path-length cs0_out rs0_in) 16)
   (= (path-length cs0_out rs0_out) 14)
   (= (path-length cs0_in rs1_in) 13)
   (= (path-length cs0_in rs1_out) 14)
   (= (path-length cs0_out rs1_in) 11)
   ...
   (= (path-length cs0_in cs1_out) 16)
   (= (path-length cs0_out cs1_in) 17)
   (= (path-length cs0_out cs1_out) 17)
   (= (path-length cs0_in ds0_in) 13)
   (= (path-length cs0_out ds0_in) 13)
   (= (path-length cs1_in bs0_in) 27)
   (= (path-length cs1_in bs0_out) 28)
   (= (path-length cs1_out bs0_in) 26)
   (= (path-length cs1_out bs0_out) 27)
   (= (path-length cs1_in rs0_in) 18)
   (= (path-length cs1_in rs0_out) 18)
   (= (path-length cs1_out rs0_in) 19)
   (= (path-length cs1_out rs0_out) 18)
   (= (path-length cs1_in rs1_in) 27)
   (= (path-length cs1_in rs1_out) 28)
   (= (path-length cs1_out rs1_in) 26)
   (= (path-length cs1_out rs1_out) 27)
   (= (path-length cs1_in cs0_in) 17)
   (= (path-length cs1_in cs0_out) 17)
   (= (path-length cs1_out cs0_in) 16)
   ...
   (= (path-length cs1_in ds0_in) 25)
   (= (path-length cs1_out ds0_in) 24)
   (= (path-length ds0_in bs0_in) 10)
   (= (path-length ds0_in bs0_out) 11)
   (= (path-length ds0_in rs0_in) 11)
   (= (path-length ds0_in rs0_out) 10)
   (= (path-length ds0_in rs1_in) 19)
   (= (path-length ds0_in rs1_out) 20)
   (= (path-length ds0_in cs0_in) 13)
   (= (path-length ds0_in cs0_out) 13)
   (= (path-length ds0_in cs1_in) 25)
   (= (path-length ds0_in cs1_out) 24)
